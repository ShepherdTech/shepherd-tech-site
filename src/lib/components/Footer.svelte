...
<footer
	class="bg-footerbg flex items-center justify-between border-t border-gray-800 px-8 py-4 text-sandcastle"
>
	<div class="flex-1">
	...
	<div>
		<div class="flex justify-center">
			<img src="Monogram_Light_sm.png" alt="ShepherdTech Logo" class="mb-4 h-14 w-14" />
		</div>
		<span class="text-sm">
			{$t('common.copyright', { companyName: 'ShepherdTech' })}
		</span>
	</div>
